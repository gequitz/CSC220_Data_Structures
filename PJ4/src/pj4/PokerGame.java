...
public class PokerGame {
   ...
   //check if it is Royal Pair
	...
	for (int i = 0; i < tempHand.length; i++) {
        ...
        SortRanks(tempRank); //sort ranks
        
        boolean isPair = false;
        
        //check if there is a pair of Aces
        for (int i=0; i<5; i++){ 
            if (tempRank[i] ==1 ){
        ...
        //check if there is a pair of Jacks
        for (int i=0; i<5; i++){ 
            if (tempRank[i] ==11 ){
        ...
        //check if there is a pair of Queens
        for (int i=0; i<5; i++){ 
            if (tempRank[i] ==12 ){
        ...
        //check if there is a pair of Kings
        for (int i=0; i<5; i++){ 
            if (tempRank[i] ==13){
	...
	for (int i = 0; i < tempHand.length; i++) {
        ...
        if (totalPairs == 2) //found two pairs
            return true;
        else
            return false;
